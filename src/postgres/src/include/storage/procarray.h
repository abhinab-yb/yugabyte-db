...
extern int SignalTracing(uint32 signal, int pid, int64 query_id, bool is_query_id_null, int trace_level);
extern int SignalTracingWithoutQueryId(uint32 signal, int pid, int trace_level);
